...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { role_id: @assignment.role_id, zombie_id: @assignment.zombie_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { role_id: @assignment.role_id, zombie_id: @assignment.zombie_id } }
